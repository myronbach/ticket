                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="row-content">
                                ...
                                <a href="/admin/roles/create" class="btn btn-default btn-raised">Create a Roles</a>
                            </div>
                        </div>
                        <div class="list-group-separator"></div>
                        <div class="list-group-item">
                            ...
                            <div class="row-content">
                                ...
                                <a href="/admin/posts/create" class="btn btn-default btn-raised">Create a Post</a>
                            </div>
                        </div>
                        <div class="list-group-separator"></div>
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="row-content">
                                ...
                                <a href="admin/categories/create" class="btn btn-default btn-raised">New Category</a>
                            </div>
                        </div>
